...
main(int argc, char *argv[])
{
    ...
    if (0 == times.size())
    {
        cout << "You must specify the times (in seconds) to be used for "
                "dilation."
             << endl;
        printUsage(argv[0]);
        return 1;
    ...
    //  render the Partials
    cout << "Exporting " << partials.size() << " dilated partials to "
         << Outname << endl;
...
{
    cout << "usage: " << programName << " filename.sdif [options] times"
         << endl;
    cout << "options:" << endl;
