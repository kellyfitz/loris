...
//
static void
test_simplePartial(void)
{
    std::cout << "\t--- testing import/export identity using a simple "
                 "Partial... ---\n\n";
...
//
static void
test_markedPartials(void)
{
    std::cout << "\t--- testing import/export identity using a marked "
                 "Partials... ---\n\n";
...
main()
{
    ...
    std::cout
        << "Relies on Breakpoint, Partial, PartialList and Partial::iterator."
        << endl
        << endl;
