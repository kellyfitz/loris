...
//
static void
test_resample_with_timing(void)
{
    ...
    */
    ...
    Partial &cp4 = *iter++;
    /*
        cout << "partial " << cp4.label() << " has " << cp4.numBreakpoints() <<
       " breakpoints" << endl; for ( Partial::iterator pit = cp4.begin(); pit !=
       cp4.end(); ++pit )
        {
            cout << pit.time() << endl;
        }
...
main()
{
    ...
    std::cout << "Uses Partial, PartialList, and LinearEnvelope." << endl
              << endl;
