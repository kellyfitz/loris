...
//
void
fixPhaseBefore(Partial &p, double t)
{
...
//
void
fixPhaseAfter(Partial &p, double t)
{
...
//
void
fixPhaseForward(Partial &p, double tbeg, double tend)
{
    if (tbeg > tend)
    {
        std::swap(tbeg, tend);
...
//
void
fixPhaseBetween(Partial &p, double tbeg, double tend)
{
    if (tbeg > tend)
    {
        std::swap(tbeg, tend);
