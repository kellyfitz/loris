...
//
static double
binFrequency(double freqHz, double regionRate)
{
// #define Use_Barks
#ifndef Use_Barks
...
//
static int
findRegionBelow(double binfreq, unsigned int howManyBins)
{
...
//
static double
computeAlpha(double binfreq, unsigned int howManyBins)
{
...
//
static void
distribute(double fractionalBin, double x, std::vector<double> &regions)
{
...
//
void
AssociateBandwidth::associateBandwidth(
    Peaks::iterator begin,    //	beginning of Peaks
