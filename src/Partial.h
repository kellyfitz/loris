...
class Partial
{
  ...
  public:
    ...
    double amplitudeAt(double time,
                       double fadeTime = ShortestSafeFadeTime) const;
    ...
    //! \pre	The Partial must have at least one Breakpoint.
    //!	\throw	InvalidPartial if the Partial has no Breakpoints.
    Breakpoint parametersAt(double time,
                            double fadeTime = ShortestSafeFadeTime) const;
...
class Partial_Iterator
{
  ...
  public:
    ...
    friend bool
    operator==(const Partial_Iterator &lhs, const Partial_Iterator &rhs)
    {
...
class Partial_ConstIterator
{
  ...
  public:
    ...
    operator++(int)
    {
        return Partial_ConstIterator(_iter++);
    }
    ...
    //!			in the same Partial, false otherwise.
    friend bool
    operator==(const Partial_ConstIterator &lhs,
