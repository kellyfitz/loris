 ...
 */
extern "C" PartialList *
createPartialList(void)
{
    try
    {
 ...
 */
extern "C" void
destroyPartialList(PartialList *ptr_this)
{
    try
    {
 ...
 */
extern "C" void
partialList_clear(PartialList *ptr_this)
{
    try
    {
        ThrowIfNull((PartialList *)ptr_this);
 ...
 */
extern "C" void
partialList_copy(PartialList *dst, const PartialList *src)
{
    try
    {
...
partialList_size(const PartialList *ptr_this)
{
    try
    {
        ThrowIfNull((PartialList *)ptr_this);
 ...
 */
extern "C" void
partialList_splice(PartialList *dst, PartialList *src)
{
    try
    {
        ThrowIfNull((PartialList *)dst);
 ...
 */
double
partial_startTime(const Partial *p)
{
    double ret = 0;
    try
    {
 ...
 */
double
partial_endTime(const Partial *p)
{
    double ret = 0;
    try
    {
 ...
 */
double
partial_duration(const Partial *p)
{
    double ret = 0;
    try
    {
 ...
 */
double
partial_initialPhase(const Partial *p)
{
    double ret = 0;
    try
    {
 ...
 */
unsigned long
partial_numBreakpoints(const Partial *p)
{
    unsigned long ret = 0;
    try
    {
 ...
 */
double
partial_frequencyAt(const Partial *p, double t)
{
    double ret = 0;
    try
    {
 ...
 */
double
partial_bandwidthAt(const Partial *p, double t)
{
    double ret = 0;
    try
    {
 ...
 */
double
partial_phaseAt(const Partial *p, double t)
{
    double ret = 0;
    try
    {
 ...
 */
double
partial_amplitudeAt(const Partial *p, double t)
{
    double ret = 0;
    try
    {
 ...
 */
void
partial_setLabel(Partial *p, int label)
{
    try
    {
        ThrowIfNull((Partial *)p);
 ...
 */
double
breakpoint_getFrequency(const Breakpoint *bp)
{
    double ret = 0;
    try
    {
 ...
 */
double
breakpoint_getAmplitude(const Breakpoint *bp)
{
    double ret = 0;
    try
    {
 ...
 */
double
breakpoint_getBandwidth(const Breakpoint *bp)
{
    double ret = 0;
    try
    {
 ...
 */
double
breakpoint_getPhase(const Breakpoint *bp)
{
    double ret = 0;
    try
    {
 ...
 */
void
breakpoint_setFrequency(Breakpoint *bp, double f)
{
    try
    {
        ThrowIfNull((Breakpoint *)bp);
 ...
 */
void
breakpoint_setAmplitude(Breakpoint *bp, double a)
{
    try
    {
        ThrowIfNull((Breakpoint *)bp);
 ...
 */
void
breakpoint_setBandwidth(Breakpoint *bp, double bw)
{
    try
    {
        ThrowIfNull((Breakpoint *)bp);
 ...
 */
void
breakpoint_setPhase(Breakpoint *bp, double phi)
{
    try
    {
        ThrowIfNull((Breakpoint *)bp);
