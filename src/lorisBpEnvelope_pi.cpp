 ...
 */
extern "C" LinearEnvelope *
copyLinearEnvelope(const LinearEnvelope *ptr_this)
{
    try
    {
 ...
 */
extern "C" void
destroyLinearEnvelope(LinearEnvelope *ptr_this)
{
    try
    {
 ...
 */
extern "C" void
linearEnvelope_insertBreakpoint(LinearEnvelope *ptr_this, double time,
                                double val)
{
    try
    {
    ...
    {
        std::string s(
            "std C++ exception in linearEnvelope_insertBreakpoint(): ");
        s.append(ex.what());
        handleException(s.c_str());
    }
}
 ...
 */
extern "C" double
linearEnvelope_valueAt(const LinearEnvelope *ptr_this, double time)
{
    try
    {
        ThrowIfNull((LinearEnvelope *)ptr_this);
