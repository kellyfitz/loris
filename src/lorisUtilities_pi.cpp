...
struct CallWithPointer
{
    ...
    void
    operator()(Partial &partial) const
    {
        func(&partial, data);
    }
};
...
struct PredWithPointer
{
    ...
    bool
    operator()(const Partial &partial) const
    {
 ...
 */
extern "C" void
copyIf(const PartialList *src, PartialList *dst,
       int (*predicate)(const Partial *p, void *data), void *data)
{
    try
    {
        ...
        std::remove_copy_if(src->begin(), src->end(), std::back_inserter(*dst),
                            [pred = PredWithPointer(predicate, data)](
                                const Partial &p) { return !pred(p); });
    }
    catch (Exception &ex)
    {
 ...
 */
extern "C" void
copyLabeled(const PartialList *src, long label, PartialList *dst)
{
    try
    {
        ThrowIfNull((PartialList *)src);
        ...
        std::remove_copy_if(src->begin(), src->end(), std::back_inserter(*dst),
                            [pred = PartialUtils::isLabelEqual(label)](
                                const Partial &p) { return !pred(p); });
    }
    catch (Exception &ex)
    {
 ...
 */
extern "C" void
crop(PartialList *partials, double t1, double t2)
{
    try
    {
 ...
 */
extern "C" void
extractIf(PartialList *src, PartialList *dst,
          int (*predicate)(const Partial *p, void *data), void *data)
{
    try
    {
        ...
        std::list<Partial>::iterator it = std::stable_partition(
            src->begin(), src->end(),
            [pred = PredWithPointer(predicate, data)](const Partial &p)
            { return !pred(p); });
        ...
        for ( it = std::find_if( src->begin(), src->end(), PredWithPointer(
        predicate, data ) ); it != src->end(); it = std::find_if( it,
        src->end(), PredWithPointer( predicate, data ) ) )
        {
 ...
 */
extern "C" void
extractLabeled(PartialList *src, long label, PartialList *dst)
{
    try
    {
        ThrowIfNull((PartialList *)src);
        ...
        std::list< Partial >::iterator it;
        for ( it = std::find_if( src->begin(), src->end(),
        PartialUtils::isLabelEqual(label) ); it != src->end(); it =
        std::find_if( it, src->end(), PartialUtils::isLabelEqual(label) ) )
        {
            //  the iterator passed to splice is a copy of it
            //  before the increment, so it is not corrupted
            //  by the splice, it is advanced to the next
 ...
 */
extern "C" void
fixPhaseAfter(PartialList *partials, double time)
{
    try
    {
        ThrowIfNull((PartialList *)partials);
 ...
 */
extern "C" void
fixPhaseAt(PartialList *partials, double time)
{
    try
    {
        ThrowIfNull((PartialList *)partials);
 ...
 */
extern "C" void
fixPhaseBefore(PartialList *partials, double time)
{
    try
    {
        ThrowIfNull((PartialList *)partials);
 ...
 */
extern "C" void
fixPhaseBetween(PartialList *partials, double tbeg, double tend)
{
    try
    {
        ThrowIfNull((PartialList *)partials);
        PartialUtils::fixPhaseBetween(partials->begin(), partials->end(), tbeg,
                                      tend);
    }
    catch (Exception &ex)
    {
 ...
 */
extern "C" void
fixPhaseForward(PartialList *partials, double tbeg, double tend)
{
    try
    {
        ThrowIfNull((PartialList *)partials);
        PartialUtils::fixPhaseForward(partials->begin(), partials->end(), tbeg,
                                      tend);
    }
    catch (Exception &ex)
    {
 ...
 */
int
forEachPartial(PartialList *src, int (*func)(Partial *p, void *data),
               void *data)
{
    int result = 0;
    try
 ...
 */
extern "C" void
removeIf(PartialList *src, int (*predicate)(const Partial *p, void *data),
         void *data)
{
    try
    {
        ThrowIfNull((PartialList *)src);
        std::list<Partial>::iterator it = std::remove_if(
            src->begin(), src->end(), PredWithPointer(predicate, data));
 ...
 */
extern "C" void
removeLabeled(PartialList *src, long label)
{
    try
    {
        ThrowIfNull((PartialList *)src);
        std::list<Partial>::iterator it = std::remove_if(
            src->begin(), src->end(), PartialUtils::isLabelEqual(label));
        src->erase(it, src->end());
    }
    catch (Exception &ex)
    {
 ...
 */
extern "C" void
scaleAmp(PartialList *partials, BreakpointEnvelope *ampEnv)
{
 ...
 */
extern "C" void
scaleAmplitude(PartialList *partials, BreakpointEnvelope *ampEnv)
{
    try
    {
        ThrowIfNull((PartialList *)partials);
        ...
        notifier << "scaling amplitude of " << partials->size() << " Partials"
                 << endl;

        PartialUtils::scaleAmplitude(partials->begin(), partials->end(),
                                     *ampEnv);
    }
    catch (Exception &ex)
    {
 ...
 */
extern "C" void
scaleBandwidth(PartialList *partials, BreakpointEnvelope *bwEnv)
{
    try
    {
        ThrowIfNull((PartialList *)partials);
        ...
        notifier << "scaling bandwidth of " << partials->size() << " Partials"
                 << endl;

        PartialUtils::scaleBandwidth(partials->begin(), partials->end(),
                                     *bwEnv);
    }
    catch (Exception &ex)
    {
 ...
 */
extern "C" void
setBandwidth(PartialList *partials, BreakpointEnvelope *bwEnv)
{
    try
    {
        ThrowIfNull((PartialList *)partials);
        ...
        notifier << "setting bandwidth of " << partials->size() << " Partials"
                 << endl;
 ...
 */
extern "C" void
scaleFrequency(PartialList *partials, BreakpointEnvelope *freqEnv)
{
    try
    {
        ThrowIfNull((PartialList *)partials);
        ...
        notifier << "scaling frequency of " << partials->size() << " Partials"
                 << endl;

        PartialUtils::scaleFrequency(partials->begin(), partials->end(),
                                     *freqEnv);
    }
    catch (Exception &ex)
    {
 ...
 */
extern "C" void
scaleNoiseRatio(PartialList *partials, BreakpointEnvelope *noiseEnv)
{
    try
    {
        ThrowIfNull((PartialList *)partials);
        ...
        notifier << "scaling noise ratio of " << partials->size() << " Partials"
                 << endl;

        PartialUtils::scaleNoiseRatio(partials->begin(), partials->end(),
                                      *noiseEnv);
    }
    catch (Exception &ex)
    {
 ...
 */
extern "C" void
shiftPitch(PartialList *partials, BreakpointEnvelope *pitchEnv)
{
    try
    {
        ThrowIfNull((PartialList *)partials);
        ...
        notifier << "shifting pitch of " << partials->size() << " Partials"
                 << endl;
 ...
 */
extern "C" void
shiftTime(PartialList *partials, double offset)
{
    try
    {
        ThrowIfNull((PartialList *)partials);

        notifier << "shifting time of " << partials->size() << " Partials"
                 << endl;
 ...
 */
static bool
local_compare_label_less(const Partial &lhs, const Partial &rhs)
{
 ...
 */
extern "C" void
sortByLabel(PartialList *partials)
{
 ...
 */
extern "C" void
timeSpan(PartialList *partials, double *tmin, double *tmax)
{
 ...
 */
extern "C" double
weightedAvgFrequency(const Partial *p)
{
    try
    {
        ThrowIfNull((Partial *)p);
